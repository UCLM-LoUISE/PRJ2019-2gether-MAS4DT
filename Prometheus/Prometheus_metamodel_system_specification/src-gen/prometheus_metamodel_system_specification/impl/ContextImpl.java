 ...
 * </p>
 * <ul>
 *   <li>{@link prometheus_metamodel_system_specification.impl.ContextImpl#getScenario <em>Scenario</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContextImpl extends EntityImpl implements Context {
	...
	protected EClass eStaticClass() {
		return Prometheus_metamodel_system_specificationPackage.Literals.CONTEXT;
	}
	...
	public EList<Scenario> getScenario() {
		if (scenario == null) {
			scenario = new EObjectWithInverseResolvingEList<Scenario>(Scenario.class, this,
					Prometheus_metamodel_system_specificationPackage.CONTEXT__SCENARIO,
					Prometheus_metamodel_system_specificationPackage.SCENARIO__CONTEXT);
		}
		return scenario;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case Prometheus_metamodel_system_specificationPackage.CONTEXT__SCENARIO:
