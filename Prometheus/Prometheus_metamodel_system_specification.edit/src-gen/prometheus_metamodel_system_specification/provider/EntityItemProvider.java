...
/**
 * This is the item provider adapter for a {@link prometheus_metamodel_system_specification.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						Prometheus_metamodel_system_specificationPackage.Literals.ENTITY__ID, true, false, false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						Prometheus_metamodel_system_specificationPackage.Literals.ENTITY__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Entity_description_feature",
								"_UI_Entity_type"),
						Prometheus_metamodel_system_specificationPackage.Literals.ENTITY__DESCRIPTION, true, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Prometheus_metamodel_system_specificationPackage.Literals.ENTITY__ATTRIBUTE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case Prometheus_metamodel_system_specificationPackage.ENTITY__ID:
		case Prometheus_metamodel_system_specificationPackage.ENTITY__NAME:
		case Prometheus_metamodel_system_specificationPackage.ENTITY__DESCRIPTION:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case Prometheus_metamodel_system_specificationPackage.ENTITY__ATTRIBUTE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(Prometheus_metamodel_system_specificationPackage.Literals.ENTITY__ATTRIBUTE,
						Prometheus_metamodel_system_specificationFactory.eINSTANCE.createAttribute()));
	}
